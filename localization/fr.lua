...
return {
    descriptions = {
        Sleeve = {
            ...
            sleeve_casl_ghost_alt = {
                name = "Pochette fantôme",
                text = {
                    "les cartes {C:spectral}Spectrales{} apparaissent",
            ...
            sleeve_casl_checkered_alt = {
                ...
                text = {
                    ...
                    "toutes les cartes {C:diamonds}Carreau{}",
            ...
            sleeve_casl_zodiac_alt = {
                name = "Pochette Zodiaque",
                text = {
                    "Les paquets {C:tarot}Tarot{} et {C:planet}Céleste{} ont ",
            ...
            sleeve_casl_erratic_alt = {
                ...
                text = {
                    ...
                    "d'{C:money}argent{}, et d'{C:attention}emplacements Joker{} initiaux",
    ...
    misc = {
        dictionary = {
            ...
            sleeve_info_location = "Emplacement d'infos pochette",
            sleeve_info_location_desc = {
                "Dans quel menu le nom et la description",
                "de la pochette utilisée est affichée",
                "(visuel seulement)"
            },
            ...
            sleeve_not_found_error = "La pochette n'a pas pu être trouvée! Avez-vous enlevé son mod d'origine?"
        },
        v_text = {
            -- for challenges
            ch_m_sleeve = {
                "Commencez avec {C:attention}#1#{}"
            }
        }
    }
}
